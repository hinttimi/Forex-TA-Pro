...
export const DashboardView: React.FC<DashboardViewProps> = ({ onSelectLesson, onSetView }) => {
  ...
  return (
    <div className="animate-fade-in-up">
      ...
      <p className="mt-1 text-lg text-[--color-muted-grey]">Your journey to trading mastery continues here.</p>
        ...
        <div className="space-y-6">
            ...
            <div className="p-6 bg-[--color-dark-matter] border border-[--color-border] rounded-xl shadow-sm">
                 ...
                 <div className="space-y-2">
                    ...
                    <button onClick={() => onSetView('simulator')} className="w-full flex items-center p-3 rounded-lg hover:bg-[--color-obsidian-slate] transition-colors"><RocketLaunchIcon className="w-6 h-6 mr-3 text-[--color-neural-blue]" /><span className="font-semibold text-white">Trade Simulator</span></button>
