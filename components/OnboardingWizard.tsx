...
export const OnboardingWizard: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center p-4">
            ...
            <div 
                className="relative bg-slate-800/50 backdrop-blur-lg border border-slate-700 rounded-2xl shadow-2xl p-8 w-full max-w-2xl text-center animate-fade-in-up"
                role="dialog"
                aria-modal="true"
            ...
            >
                 <div className="flex items-center justify-center space-x-3 mb-4">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight text-white">Welcome to Forex TA Pro</h1>
                </div>

                <h2 id="onboarding-title" className="text-2xl font-bold text-white mt-6">
                ...
                <div className="mt-8 text-left">
                     <label htmlFor="api-key-input" className="block text-sm font-medium text-slate-300 mb-2">Your Gemini API Key</label>
                    <input 
                        id="api-key-input"
                        type="password"
                        value={currentKey}
                        ...
                        className="w-full bg-slate-900 border border-slate-600 rounded-lg py-3 px-4 text-white placeholder-slate-500 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
                ...
                <div className="mt-8">
                     <button
                        ...
                        className="w-full inline-flex justify-center items-center px-6 py-3 border border-transparent text-lg font-semibold rounded-lg shadow-sm text-slate-900 bg-cyan-500 hover:bg-cyan-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-800 focus:ring-cyan-500 disabled:bg-slate-600 disabled:cursor-not-allowed transition-transform duration-200 hover:scale-105"
                    >
